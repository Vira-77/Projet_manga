...
async function addSampleData() {
    try {
        ...
        const shonen = await Genre.create({
            name: 'Shonen',
            description: 'Mangas d’action et d’aventure destinés à un public jeune masculin.'
        });

        const shojo = await Genre.create({
            name: 'Shojo',
            description: 'Mangas centrés sur les relations et les émotions, destinés à un public jeune féminin.'
        });
